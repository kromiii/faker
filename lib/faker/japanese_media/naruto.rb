  ...
  class JapaneseMedia
    class Naruto < Base
      class << self
        ...
        ##
        # Produces a quote from Naruto like sentences (generated by LLM).
        #
        # @return [String]
        #
        # @example
        #   Faker::JapaneseMedia::StudioGhibli.naruto #=> "One thing you can always count on is that hearts change."
        #
        # @faker.version next
        def quote
          fetch('naruto.quotes')
